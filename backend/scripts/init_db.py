...
try:
    ...
    print("Please ensure you run this script from the OPMAS project root directory", file=sys.stderr)
...
def main():
    ...
    try:
        ...
        logger.error("Please check your PostgreSQL server is running and the connection details in config/opmas_config.yaml are correct.")
        sys.exit(1)
