...
def test_logging_config() -> LoggingConfig:
    ...
    return LoggingConfig(level="DEBUG", format="json", rotation="1 day", retention="7 days")
...
def test_agent(db_session):
    """Create a test agent."""
    from opmas.models.agent import Agent, AgentStatus, AgentType
...
def test_agent_data():
    ...
    return {
        ...
        "type": "wifi",
        "status": "active",
        "configuration": {"enabled": True, "rules": []},
    }
