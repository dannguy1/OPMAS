...
@router.get("/findings", response_model=FindingsResponse, summary="Get historical findings")
async def get_findings(
    ...
    try:
        ...
        return FindingsResponse(findings=findings_orm, total=total, limit=limit, offset=offset)
